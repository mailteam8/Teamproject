...
# دالة رفع الملف إلى GitHub (مع تحديث إذا موجود مسبقًا)
...
# ✅ تحديث النموذج يدويًا + رفعه إلى GitHub
...
# ✅ التنبؤ مع تشخيص موسّع + تقرير + تنبيه
...
def predict_patient(pat_id: str):
    ...
    # ✅ تخزين التقرير في جدول tbl_report
    report_data = {
    ...
    # ✅ إضافة تنبيه في جدول tb_alert إذا الخطورة عالية مع رسالة خاصة
    alert_response = None
    if severity >= 3:
